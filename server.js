...
// Bump Offers (결제 직전 추가 상품)
const BUMP_OFFERS = {
  extraPhoto: {
    id: 'extraPhoto',
    name: '추가 사진 2장',
    price: 2900,
    description: '다른 앵글의 산타 사진 2장 추가'
  },
  framePrint: {
    id: 'framePrint',
    name: '액자 인화 서비스',
    price: 4900,
    description: '프리미엄 액자에 인화하여 배송'
  },
  voiceMessage: {
    id: 'voiceMessage', 
    name: '산타 음성메시지',
    price: 3900,
    description: '아이 이름을 부르는 산타 음성 파일'
  }
};
